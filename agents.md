...
- Auto-detects `IDA_MACOS_DIR` as the newest `/Applications/IDA Professional*.app/Contents/MacOS` containing `libidalib.dylib`; fails at configure time if none is found.
